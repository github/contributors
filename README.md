...
1. Edit the values (`ORGANIZATION`, `REPOSITORY`, `TIME_PERIOD`) from the sample workflow with your information.
...
| `ORGANIZATION`        | Required to have `ORGANIZATION` or `REPOSITORY` |         | The name of the GitHub organization which you want the contributor information from. ie. `github` |
...
| `START_DATE`                | False |   All time      | The time from which you want to start gathering contributor information. ie. `2023-08-01` |
| `END_DATE`                | False |   All time      | The time at which you want to stop gathering contributor information. Must be later than the `START_DATE`. ie. `2023-08-01` |
